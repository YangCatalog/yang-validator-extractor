...
urlpatterns = [
    ...
    path('yangvalidator/api/v1/datatracker/draft', views.datatracker_draft, name='datatracker_draft'),
    path('yangvalidator/api/v1/datatracker/rfc', views.datatracker_rfc, name='datatracker_rfc'),
